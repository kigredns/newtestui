...
HawkLib = {
	...
	Themes = {
		Dark = {
			...
			TitleBar = Color3.fromRGB(0, 1, 1),
			TabBefore = Color3.fromRGB(33, 33, 33),
			TabAfter = Color3.fromRGB(41, 41, 41),
			TitleTextColor = Color3.fromRGB(0, 1, 1),
			TabTextColor = Color3.fromRGB(0, 1, 1),
			TitleLineColor = Color3.fromRGB(0, 1, 1),
			PageTitleColor = Color3.fromRGB(0, 1, 1),
