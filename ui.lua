...
HawkLib = {
	...
	Themes = {
		Dark = {
			...
			TabBefore = Color3.fromRGB(5, 5, 5),
			TabAfter = Color3.fromRGB(16, 16, 16),
			TitleTextColor = Color3.fromRGB(0, 111, 111),
			TabTextColor = Color3.fromRGB(0, 255, 255),
			TitleLineColor = Color3.fromRGB(0, 255, 255),
			PageTitleColor = Color3.fromRGB(0, 255, 255),
			Selection = Color3.fromRGB(0, 255, 255),
			CloseMinimize = Color3.fromRGB(255, 0, 0),
			ItemColors = Color3.fromRGB(10, 10, 10),
			ItemTitleColors = Color3.fromRGB(0, 255, 255),
			ItemTextColors = Color3.fromRGB(0, 255, 255),
			ItemTextBoxKeyBindColors = Color3.fromRGB(10, 10, 10),
			ItemTextBoxKeyBindStrokeColors = Color3.fromRGB(10, 10, 10),
			...
			ButtonHover = Color3.fromRGB(10, 10, 10),		
			SliderButtonFrameColor = Color3.fromRGB(10, 10, 10),
